...
export const Sidebar = ({ isOpen, onToggle }: SidebarProps) => {
  ...
  return (
    <aside
      className={`h-full shrink-0 overflow-hidden bg-zinc-100 transition-all duration-300 ease-in-out dark:bg-zinc-900 ${isOpen ? 'w-64 p-4' : 'w-0 p-0'} fixed z-20 md:relative ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}
    >
      {isOpen && (
        <div className="flex h-full w-56 flex-col">
          ...
          <TagList />
          <div className="shrink-0 border-t border-zinc-200 pt-4 dark:border-zinc-700">
